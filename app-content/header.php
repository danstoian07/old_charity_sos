			...
			$str_footer_news .= '
				  <article class="post media-post clearfix pb-0 mb-10">
					...
					<div class="post-right">
					  ...
					  <p class="post-date mb-0 font-12">SOS Umanitar Association</p>
					</div>
				  </article>'.PHP_EOL;
					...
					<div class="entry-content p-20">
					  ...
					  <div class="entry-meta">
						<ul class="list-inline font-12 mb-10">
						  ...
						  <li><i class="fa fa-calendar text-theme-colored mr-5"></i> Articles  </li>                      
						</ul>
					  </div>
    ...
    <div class="header-top bg-black-333 sm-text-center border-top-theme-color-3px p-0">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2">
            <a class="btn btn-colored btn-flat btn-theme-colored pb-10" href="<?=$this->return_link_to_doneaza()?>"><strong class="white">DONATE NOW</strong></a>
          </div>
        </div>
      </div>
    </div>
