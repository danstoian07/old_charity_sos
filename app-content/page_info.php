        ...
        <div class="row mtli-row-clearfix">
              ...
              <div class="campaign-details clearfix p-15 pt-10 pb-10">
                ...
                <div class="campaign-bottom border-top clearfix mt-20">
                  <ul class="list-inline font-weight-600 pull-left flip pr-0 mt-10">
                    <li class="text-gray pr-0 mr-5">Humanitarian <span class="text-theme-colored">activities</span> |</li>
                    <li>
                      <div class="star-rating" title=""><span style="width: 100%;">5</span></div>
                    </li>
                  </ul>
                  <a class="btn btn-xs btn-theme-colored font-weight-600 font-11 pull-right flip mt-10" href="<?=$this->return_link_to_doneaza()?>">Donate now</a>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="sidebar sidebar-right mt-sm-30">
              <div class="widget">
                <h5 class="widget-title line-bottom">Humanitarian activities</h5>
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="call-to-action sm-text-center p-0 pt-30 pb-20">
            <div class="col-md-9">
              <h3 class="mt-5 text-white">Save a child's life, help the old and the street people!</h3>
            </div>
            <div class="col-md-3 text-right flip sm-text-center"> 
              <a href="<?=$this->return_link_to_doneaza()?>" class="btn btn-default btn-circled btn-lg mt-5">Donate here<i class="fa fa-angle-double-right font-16 ml-10"></i></a> 
            </div>
          </div>
        </div>
      </div>
