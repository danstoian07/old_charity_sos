<?php
	...
	define('__URL__', "https://www.charity-sos.com/fr".DIRECTORY_SEPARATOR);
	...
	define('APP_WEBSITE', 'https://www.charity-sos.com/fr');            	/* website aplicatie, inclusiv http:// */
