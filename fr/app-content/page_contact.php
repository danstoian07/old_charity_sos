    ...
    <section class="divider">
      <div class="container pt-sm-10 pb-sm-30">
        <div class="row pt-30">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-map-2 text-theme-colored"></i></a>
                  <div class="media-body"> <strong>ADRESSE</strong>
          ...
          <div class="col-md-8">
            <h3 class="mt-0 mb-20">Laissez-nous un message</h3>
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="<?=__APPFILESURL__?>includes/quickcontact.php" method="post">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
					...
					<input id="form_name" name="form_name" class="form-control" type="text" placeholder="Nom" required="">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="form_email" name="form_email" class="form-control required email" type="email" placeholder="E-mail">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_name">Sujet <small>*</small></label>
                    <input id="form_subject" name="form_subject" class="form-control required" type="text" placeholder="Sujet">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_phone">Téléphone <small>*</small></label>
                    <input id="form_phone" name="form_phone" class="form-control required" type="text" placeholder="Téléphone" required="">
                  </div>
                </div>
              </div>

              <div class="form-group">
                <label for="form_message">Commentaires</label>
				<input id="form_address" name="form_address" class="form-control noafis" type="text" placeholder="Address" required="">
                <textarea id="form_message" name="form_message" class="form-control required" rows="5" placeholder="Commentaires"></textarea>
              </div>
              <div class="form-group">
