...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' AND $_POST['form_sex'] != '' AND $_POST['form_branch'] != '' AND $_POST['form_message'] != '' ) {

        $name = $_POST['form_name'];
        $email = $_POST['form_email'];
        $sex = $_POST['form_sex'];
        $job_branch = $_POST['form_branch'];
        $message = $_POST['form_message'];

        $subject = isset($subject) ? $subject : 'New Message | Become a Volunteer';
        ...
        if( $botcheck == '' ) {
            ...
            $job_branch = isset($job_branch) ? "Branch: $job_branch<br><br>" : '';
            $message = isset($message) ? "Message: $message<br><br>" : '';

            $referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>This Form was submitted from: ' . $_SERVER['HTTP_REFERER'] : '';

            $body = "$name $email $sex $job_branch $message $referrer";
