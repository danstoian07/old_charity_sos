...
<html lang="en">
    ...
    <head>
		...
		<!-- help resources -->
        <link href="<?=__THEMEURL__?>assets/pages/css/profile.min.css" rel="stylesheet" type="text/css" />
        <link href="<?=__THEMEURL__?>assets/apps/css/ticket.min.css" rel="stylesheet" type="text/css" />
		<!-- end help resources -->		
