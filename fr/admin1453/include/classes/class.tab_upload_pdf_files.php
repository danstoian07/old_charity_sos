...
class tab_upload_pdf_files extends tab_upload {
	public  $upload_table_name                    	= 'files';						/* table in witch will be stored uploaded files info (without app prefix) */	
		...
		$tab_content = '
													...
													<div id="tab_images_uploader_container" class="text-align-reverse margin-bottom-10">
                                                        <a id="tab_images_uploader_pickfiles" href="javascript:;" class="btn btn-success">
                                                            <i class="fa fa-plus"></i> Selecteaza Fisiere PDF </a>
