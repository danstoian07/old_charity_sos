...
class archive_utile extends archive {
	/* ------------------------------------------------------------------------------------- */	
	public  $table_name                         = 'app_settings';
	public  $ida							    = 0;
	public  $permission_add_item      		    = 0;								/* */	
	public  $permission_edit_item               = 1;  								/* */		
	public  $archive_title			        	= 'Edit';
	public  $archive_icon_class     			= 'fa fa-folder';

	public  $list_archive_title			    	= 'Useful';					/* Title of archive list */
	public  $list_archive_icon_class        	= 'fa fa-folder';						/* icon for title of archive list */
	public  $list_add_button_name               = 'Add setting';
	public  $list_edit_item_button_name         = 'Edit';
	
	
	public  $tabs   			    			= array(
													array('<i class="fa fa-globe"></i> Continents','tab_article_continente'),
													array('<i class="fa fa-language"></i> Languages','tab_article_limbi'),
													array('<i class="fa fa-money"></i> Currency','tab_article_monede'),
													array('<i class="fa fa-list"></i> Public areas type','tab_article_tip_zonepublice'),
													array('<i class="fa fa-list"></i> Cabin\'s view type','tab_article_tip_viewmode'),
													array('<i class="fa fa-list"></i> Cabin\'s view areas','tab_article_tip_viewarea'),
													array('<i class="fa fa-shower"></i> Bath utilities','tab_article_tip_baie'),
												);									/* Edit Panel tabs, bidimensional array Ex: (($tab_name1, $tab_class1),($tab_name1, $tab_class1) ...) */

	public  $archive_title_top_big          	= 'Useful';
	public  $archive_title_top_small        	= '';
	public  $activate_menuitem_id           	= 130;								/* id of menuitem wich will be active when panel show */
	...
	public function ShowEdit($id) {
		$breadcrumb_title = 'Useful archive';
		$this->archive_title = 'Useful archive';
