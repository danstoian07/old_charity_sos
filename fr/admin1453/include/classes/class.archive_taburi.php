...
class archive_taburi extends archive {
	/* ------------------------------------------------------------------------------------- */	
	public  $table_name                         = 'tabs';
	public  $ida							    = 0;
	public  $permission_add_item      		    = 1;								/* */	
	public  $permission_edit_item               = 1;  								/* */		
	public  $archive_title			        	= 'Editare detalii tab';
	public  $archive_icon_class     			= 'fa fa-folder-open-o';

	public  $list_archive_title			    	= 'Lista TAB-uri articol';					/* Title of archive list */
	public  $list_archive_icon_class        	= 'fa fa-folder-open-o';						/* icon for title of archive list */
	public  $list_add_button_name               = 'Adauga TAB';
	public  $list_edit_item_button_name         = 'Editeaza';
	
	
	public  $tabs   			    			= array(
													array('<i class="fa fa-pencil"></i> Editeaza TAB','tab_taburi_general'),
												);									/* Edit Panel tabs, bidimensional array Ex: (($tab_name1, $tab_class1),($tab_name1, $tab_class1) ...) */

	public  $archive_title_top_big          	= 'TAB-uri articol';
	...
	public $list_fields = array(
				  ...
				  'function'                           => 'lf_return_tab',  /* Method must have parameter "$result_line" */
                   ),
	...
	public function ShowEdit($id) {
		...
		if ($id_decript!=0) { 
			...
			$breadcrumb_title = 'Panou TAB';
			$this->archive_title = 'Panou TAB [ <span class="font-green-sharp bold uppercase">'.$categ_name.'</span> ]';
			} else { $this->archive_title = 'Adaugare TAB articol'; $breadcrumb_title = $this->archive_title;}
	...
	*/
	/* ------------------------------------------------------------------------------------- */		
	public function lf_return_tab($result_line, $link_to_edit){
