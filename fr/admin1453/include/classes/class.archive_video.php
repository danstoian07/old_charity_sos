...
class archive_video extends archive {
	/* ------------------------------------------------------------------------------------- */	
	public  $table_name                         = 'afise';
	public  $ida							    = 40;
	public  $permission_add_item      		    = 1;								/* */	
	public  $permission_edit_item               = 1;  								/* */		
	public  $archive_title			        	= 'Editare detalii videoclip';
	public  $archive_icon_class     			= 'fa fa-video-camera';

	public  $list_archive_title			    	= 'Lista videoclipuri';					/* Title of archive list */
	public  $list_archive_icon_class        	= 'fa fa-video-camera';						/* icon for title of archive list */
	public  $list_add_button_name               = 'Adauga videoclip Youtube';
	public  $list_edit_item_button_name         = 'Editeaza';
	
	
	public  $tabs   			    			= array(
													array('<i class="fa fa-pencil"></i> Editeaza clip video','tab_video_general'),
	...
	public  $archive_title_top_big          	= 'Galerie Video Muzeul Brailei';
	public  $archive_title_top_small        	= '';
	public  $activate_menuitem_id           	= 19;								/* id of menuitem wich will be active when panel show */
	...
	public $list_fields = array(
				  ...
				  'filter'                             => array (
																  ...
																  'options' => array(
																				   ...
																				   array ( 'value' =>  '0', 'title' => 'NEAFISAT in Homepage', ),
																				   array ( 'value' =>  '1', 'title' => 'AFISAT in Homepage', ),
																				),																  
																),				  																				  				  
				  'width'                              => '120',
				  'sortable'                           => true,
				  ...
				  'function'                           => 'lf_return_first_page_icon',  
                   ),
	...
	*/	
	...
	public function lf_return_photo($result_line){
		$src= (el_valid_youtube_link($result_line['download']) ? 'https://img.youtube.com/vi/'.el_return_youtube_id($result_line['download']).'/default.jpg' : __APPFILESURL__.'img/video-120x90.jpg');
		return '<img src="'.$src.'" />';
	}		
	/* ------------------------------------------------------------------------------------- */		
	public function lf_return_first_page_icon($result_line){
		$ret_value = '';
		if ($result_line['show_fp']!=0) {
			$ret_value = '<i class="fa fa-check"></i>';
		}
		return $ret_value;
	}	
