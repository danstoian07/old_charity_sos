...
class archive_setari_afise extends archive {
	/* ------------------------------------------------------------------------------------- */	
	...
	public  $tabs   			    			= array(
													array('<i class="fa fa-camera"></i> Colectia de afise','tab_upload_photo_files'),
	...
	public  $activate_menuitem_id           	= 1111;								/* id of menuitem wich will be active when panel show */
