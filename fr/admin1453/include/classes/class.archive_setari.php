...
class archive_setari extends archive {
	/* ------------------------------------------------------------------------------------- */	
	...
	public  $tabs   			    			= array(
													...
													array('<i class="fa fa-camera"></i> Poze lateral articole (365x230)','tab_upload_photo_files'),
	...
	public  $activate_menuitem_id           	= 100;								/* id of menuitem wich will be active when panel show */
