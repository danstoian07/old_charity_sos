...
Class AppMain
{
	...
	public function DisplayPanel(){
		...
		switch ($this->pn) {
			...
			case 133: 
					/* afisare pagina CONTACT */					
					$this->meta_title       = 'Faites un don | Association S.O.S. Umanitar';
					$this->meta_description = '';
					$this->meta_keywords    = '';
					$this->og_title         = $this->meta_title;
					$this->og_description   = $this->meta_description;
	...
	public function return_link_to_doneaza(){
		return __URL__.'faites-un-don'.DIRECTORY_SEPARATOR;
	}				
	/* ------------------------------------------------------------------------------------- */	
	...
	public function return_link_to_notfound(){
		return __URL__.'page-non-trouvee'.DIRECTORY_SEPARATOR;
	}								
	/* ------------------------------------------------------------------------------------- */	
