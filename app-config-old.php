<?php
	...
	define('__URL__', "https://www.charity-sos.com".DIRECTORY_SEPARATOR);
	...
	define('APP_WEBSITE', 'http://www.charity-sos.com');            	/* website aplicatie, inclusiv http:// */
