...
class archive_anunturi extends archive {
	...
	public  $archive_title_top_big          	= 'Anunturi muzeu';
	public  $archive_title_top_small        	= '';
	public  $activate_menuitem_id           	= 14;								/* id of menuitem wich will be active when panel show */
	...
	public $list_fields = array(
				  ...
				  'filter'                             => array (
																  ...
																  'options' => array(
																				   ...
																				   array ( 'value' =>  '1', 'title' => 'Achizitii publice', ),
																				   array ( 'value' =>  '2', 'title' => 'Angajari', ),
																				   array ( 'value' =>  '0', 'title' => 'Diverse', ),
																				),																  
																),				  																				  				  
				  'width'                              => '120',
				  'sortable'                           => true,
	...
	public function ShowEdit($id) {
		...
		if ($id_decript!=0) { 
			...
			$this->archive_title = 'Panou anunt [ <span class="font-green-sharp bold uppercase">'.$categ_name.'</span> ]';
			} else { $this->archive_title = 'Adaugare anunt'; $breadcrumb_title = $this->archive_title;}
	...
	public function lf_return_type($result_line){		
		//$result_line['type_ads']
		switch ($result_line['type_ads']) {
			case 0: $ret= 'diverse'; break;
			case 1: $ret= 'achizitii'; break;
			case 2: $ret= 'angajari'; break;
			default: $ret= ''; break;
		}		
		return '<span class="font-grey-salt">'.$ret.'</span>';
	}			
	/* ------------------------------------------------------------------------------------- */
