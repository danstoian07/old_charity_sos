...
class archive_infoutile extends archive {
	/* ------------------------------------------------------------------------------------- */	
	public  $table_name                         = 'articles';
	public  $ida							    = 50;
	public  $permission_add_item      		    = 1;								/* */	
	public  $permission_edit_item               = 1;  								/* */		
	public  $archive_title			        	= 'Editare detalii serviciu';
	public  $archive_icon_class     			= 'fa fa-info-circle';

	public  $list_archive_title			    	= 'Lista servicii';					/* Title of archive list */
	public  $list_archive_icon_class        	= 'fa fa-info-circle';						/* icon for title of archive list */
	public  $list_add_button_name               = 'Adauga serviciu';
	public  $list_edit_item_button_name         = 'Editeaza';
	
	
	public  $tabs   			    			= array(
													array('<i class="fa fa-pencil"></i> Editeaza serviciu','tab_infoutile_general'),													
												);									/* Edit Panel tabs, bidimensional array Ex: (($tab_name1, $tab_class1),($tab_name1, $tab_class1) ...) */

	public  $archive_title_top_big          	= 'Activitati SOS Umanitar';
	public  $archive_title_top_small        	= '';
	public  $activate_menuitem_id           	= 33;								/* id of menuitem wich will be active when panel show */
	...
	public function ShowEdit($id) {
		...
		if ($id_decript!=0) { 
			...
			$this->archive_title = 'Panou informatii utile [ <span class="font-green-sharp bold uppercase">'.$categ_name.'</span> ]';
			} else { $this->archive_title = 'Adaugare informatii utile'; $breadcrumb_title = $this->archive_title;}
