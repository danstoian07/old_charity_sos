...
class archive_editura extends archive {
	/* ------------------------------------------------------------------------------------- */	
	public  $table_name                         = 'afise';
	public  $ida							    = 20;
	public  $permission_add_item      		    = 1;								/* */	
	public  $permission_edit_item               = 1;  								/* */		
	public  $archive_title			        	= 'Editare detalii publicatie';
	public  $archive_icon_class     			= 'fa fa-file-text-o';

	public  $list_archive_title			    	= 'Lista publicatii EDITURA ISTROS';					/* Title of archive list */
	public  $list_archive_icon_class        	= 'fa fa-file-text-o';						/* icon for title of archive list */
	public  $list_add_button_name               = 'Adauga publicatie';
	public  $list_edit_item_button_name         = 'Editeaza';
	
	
	public  $tabs   			    			= array(
													array('<i class="fa fa-pencil"></i> Editeaza publicatie Editura Istros','tab_editura_general'),
	...
	public  $archive_title_top_big          	= 'EDITURA ISTROS, Muzeul Brailei';
	public  $archive_title_top_small        	= '';
	public  $activate_menuitem_id           	= 17;								/* id of menuitem wich will be active when panel show */
