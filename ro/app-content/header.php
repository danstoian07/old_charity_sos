			...
			$str_footer_news .= '
				  <article class="post media-post clearfix pb-0 mb-10">
					...
					<div class="post-right">
					  ...
					  <p class="post-date mb-0 font-12">Asociatia SOS umanitar</p>
					</div>
				  </article>'.PHP_EOL;
					...
					<div class="entry-content p-20">
					  ...
					  <div class="entry-meta">
						<ul class="list-inline font-12 mb-10">
						  <li><i class="fa fa-user text-theme-colored mr-5"></i>Autor: CALIN MAGDA / </li>
						  <li><i class="fa fa-calendar text-theme-colored mr-5"></i> Articole psihologie  </li>                      
						</ul>
					  </div>
...
<div id="wrapper" class="clearfix">
  ...
  <div id="preloader">
    <div id="spinner">
      ...
      <h5 class="line-height-50 font-18">Incarcare...</h5>
    </div>
    ...
    <div class="header-top bg-black-333 sm-text-center border-top-theme-color-3px p-0">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2">
            <a class="btn btn-colored btn-flat btn-theme-colored pb-10" href="<?=$this->return_link_to_doneaza()?>"><strong class="white">DONEAZA ACUM</strong></a>
          </div>
        </div>
      </div>
    </div>
