  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="<?=__APPFILESURL__?>images/slider/top.jpg">
      <div class="container pt-70 pb-50">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12">
              <h4 class="title text-white">DONEAZA AICI</h4>
              <ul class="breadcrumb white">
                <li><a class="text-white" href="<?=__URL__?>">Home</a></li>
                <li class="active">Doneaza acum, SOS Umanitar</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="divider">
      <div class="container pt-sm-10 pb-sm-30">
        <div class="row pt-30">
          <div class="col-md-8">
            <h1 class="mt-0 mb-20">Doneaza acum</h1>
			...
			?>
			<blockquote>
			<p>Ajuta prin donarea unei sume de bani in contul Asociatiei noastre&nbsp; S.O.S. Umanitar cu&nbsp; nr&nbsp; RO16 BACX 0000 0013 7379 9001 dechis la&nbsp; Banca Unicredit Galati, Romania.</p>
			</blockquote>

			<blockquote>
			<p>Expediati pe adresa noastra <strong>Asociatia S.O.S. UMANITAR</strong>, str. Aleea&nbsp; Melodiei nr. 8 Bl. B8 Sc. 5&nbsp; ap. 49 Cam. 3, Galati, Romania, C.I.F. 36840122, colete cu ajutoare umanitare care vor fi redistribuite ulterior.</p>
			</blockquote>
			<!--
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-map-2 text-theme-colored"></i></a>
                  <div class="media-body"> <strong>DONEAZA</strong>
                    <p>Ajuta-ne prin donarea unei sume de bani in contul <strong>Asociatiei S.O.S. Umanitar</strong> cu  nr  <strong>RO16 BACX 0000 0013 7379 9001</strong> dechis la <strong>Banca Unicredit Galati, Romania</strong>.</p>
                  </div>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-12">
                <div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-call text-theme-colored"></i></a>
                  <div class="media-body"> <strong>TELEFON</strong>
