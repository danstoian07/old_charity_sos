            ...
            <ul>
                <li>
                    <a href="" target="_blank" class="active">
                        <span>Adauga Dosar</span>
                        <i class="icon-basket"></i>
                    </a>
                </li>
                <li>
                    <a href="" target="_blank">
                        <span>Adauga Contract</span>
                        <i class="icon-users"></i>
                    </a>
                </li>
                <li>
                    <a href="" target="_blank">
                        <span>Adauga Client</span>
                        <i class="icon-user"></i>
                    </a>
                </li>
                <li>
...
<![endif]-->
        ...
        <!--
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
        -->
        <!--
        <script src="<?=__THEMEURL__?>assets/global/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jquery.sparkline.min.js" type="text/javascript"></script>
        -->
        <!--
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
        <script src="<?=__THEMEURL__?>assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>
        -->
			...
			var TableDatatablesAjax = function () {
				...
				var handleRecords = function () {
					...
					<!-- *********************** -->
											arr_index = new Array();
											arr_class = new Array();
											var no_of_responsive_columns =0;
											$('#datatable_ajax thead tr.heading th[class]').each(function () {
												arr_index.push($(this).index());
												arr_class.push(this.className);
												no_of_responsive_columns++;
											});
											//alert(arr_class[0]);
					...
					grid.init({
						...
						dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
							...
							"ajax": {
								"url": "action/ajax-archive-list.php?archtype=<?=$this->archtype?>", // ajax source
							},
							"order": [
								[<?=$this->list_fields_order_by_fiels_no?>, "<?=$this->list_fields_order_by_direction?>"]
									...
									foreach ($this->list_fields as $column) {
										...
										if (isset($column['sortable'])) {
											if ($column['sortable']==false) {
												echo '{orderable: false, targets: '.$contor_fields.' },';
											}
										}
									}
								?>
							...
							"createdRow": function( row, data, dataIndex ) {
							   ...
							   //$('td:eq(2)', row).addClass('xxx');
							   
								for (i = 0; i < no_of_responsive_columns; i++) {
								   $('td:eq('+arr_index[i]+')', row).addClass(arr_class[i]);
								}
		...
		?>	
		<!-- general app footer scripts -->
		<?php
			if (property_exists($this->parent, 'app_footer_scripts')) {
				$last_value='';
				foreach ($this->parent->app_footer_scripts as $key => $value) {
					if ($value!=$last_value) {
						echo $value.PHP_EOL;
						$last_value = $value;
					}
