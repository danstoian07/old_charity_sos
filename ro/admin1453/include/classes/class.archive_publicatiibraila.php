...
class archive_publicatiibraila extends archive {
	/* ------------------------------------------------------------------------------------- */	
	public  $table_name                         = 'afise';
	public  $ida							    = 30;
	public  $permission_add_item      		    = 1;								/* */	
	public  $permission_edit_item               = 1;  								/* */		
	public  $archive_title			        	= 'Editare detalii publicatie Braila';
	public  $archive_icon_class     			= 'fa fa-file-text';

	public  $list_archive_title			    	= 'Lista publicatii BRAILA';					/* Title of archive list */
	public  $list_archive_icon_class        	= 'fa fa-file-text';						/* icon for title of archive list */
	public  $list_add_button_name               = 'Adauga publicatie BRAILA';
	public  $list_edit_item_button_name         = 'Editeaza';
	
	
	public  $tabs   			    			= array(
													array('<i class="fa fa-pencil"></i> Editeaza publicatie BRAILA','tab_publicatiibraila_general'),
	...
	public  $archive_title_top_big          	= 'Publicatii BRAILA';
	public  $archive_title_top_small        	= '';
	public  $activate_menuitem_id           	= 18;								/* id of menuitem wich will be active when panel show */
	...
	public $list_fields = array(
				  ...
				  'filter'                             => array (
																  ...
																  'options' => array(
																				   ...
																				   array ( 'value' =>  '31', 'title' => 'Periodice', ),
																				   array ( 'value' =>  '32', 'title' => 'Arheologie', ),
																				   array ( 'value' =>  '33', 'title' => 'Istorie si memorialistica', ),
																				   array ( 'value' =>  '34', 'title' => 'Albume si multimedia', ),
																				),																  
																),				  																				  				  
				  'width'                              => '120',
				  'sortable'                           => true,
