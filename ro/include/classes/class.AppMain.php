...
Class AppMain
{
	...
	public function DisplayPanel(){
		...
		switch ($this->pn) {
			...
			case 13: 
					...
					$this->meta_title       = 'Contact | Asociatia SOS Umanitar';
					$this->meta_description = 'Ne puteti contacta la tel. 0784025740, prin e-mail sau prin intermediul formularului de contact din pagina curenta.';
					$this->meta_keywords    = '';
					$this->og_title         = $this->meta_title;
					$this->og_description   = $this->meta_description;
			...
			case 133: 
					/* afisare pagina CONTACT */					
					$this->meta_title       = 'Doneaza acum | Asociatia SOS Umanitar';
					$this->meta_description = '';
					$this->meta_keywords    = '';
					$this->og_title         = $this->meta_title;
					$this->og_description   = $this->meta_description;
	...
	public function return_link_to_doneaza(){
		return __URL__.'doneaza'.DIRECTORY_SEPARATOR;
	}				
	/* ------------------------------------------------------------------------------------- */	
	...
	public function return_link_to_notfound(){
		return __URL__.'pagina-nu-exista'.DIRECTORY_SEPARATOR;
	}								
	/* ------------------------------------------------------------------------------------- */	
